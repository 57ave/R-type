#ifndef RTYPE_ENGINE_SHOOTEMUP_COMPONENTS_POWERUP_HPP
#define RTYPE_ENGINE_SHOOTEMUP_COMPONENTS_POWERUP_HPP
...
#endif  // RTYPE_ENGINE_SHOOTEMUP_COMPONENTS_POWERUP_HPP
