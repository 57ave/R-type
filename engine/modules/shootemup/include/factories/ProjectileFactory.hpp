...
public:
     ...
     */
    static ECS::Entity CreateProjectileFromSpec(ECS::Coordinator& coordinator, float x, float y,
                                                SFMLTexture* texture,
     ...
     */
    static ECS::Entity CreateNormalProjectile(ECS::Coordinator& coordinator, float x, float y,
                                              SFMLTexture* texture,
                                              std::vector<SFMLSprite*>& spriteList,
                                              bool isPlayerProjectile = true, int ownerId = 0);
     ...
     */
    static ECS::Entity CreateChargedProjectile(ECS::Coordinator& coordinator, float x, float y,
                                               int chargeLevel, SFMLTexture* texture,
                                               std::vector<SFMLSprite*>& spriteList,
                                               bool isPlayerProjectile = true, int ownerId = 0);
     ...
     */
    static ECS::Entity CreateExplosiveProjectile(ECS::Coordinator& coordinator, float x, float y,
                                                 SFMLTexture* texture,
                                                 std::vector<SFMLSprite*>& spriteList,
                                                 bool isPlayerProjectile = true, int ownerId = 0);
     ...
     */
    static ECS::Entity CreatePiercingProjectile(ECS::Coordinator& coordinator, float x, float y,
                                                int maxPierceCount, SFMLTexture* texture,
                                                std::vector<SFMLSprite*>& spriteList,
                                                bool isPlayerProjectile = true, int ownerId = 0);
     ...
     */
    static ECS::Entity CreateHomingProjectile(ECS::Coordinator& coordinator, float x, float y,
                                              SFMLTexture* texture,
                                              std::vector<SFMLSprite*>& spriteList,
                                              bool isPlayerProjectile = true, int ownerId = 0);
     ...
     */
    static ECS::Entity CreateLaserProjectile(ECS::Coordinator& coordinator, float x, float y,
                                             SFMLTexture* texture,
                                             std::vector<SFMLSprite*>& spriteList,
                                             bool isPlayerProjectile = true, int ownerId = 0);
     ...
     */
    static ECS::Entity CreateProjectile(ECS::Coordinator& coordinator,
...
private:
    ...
    static SFMLSprite* CreateProjectileSprite(float x, float y, SFMLTexture* texture, int spriteX,
