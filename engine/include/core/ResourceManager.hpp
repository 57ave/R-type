        ...
        namespace core {
            ...
            class ResourceManager {
                public:
                    ...
                    void setTextureFactory(std::function<std::shared_ptr<eng::engine::rendering::ITexture>()> factory);
                    void setSpriteFactory(std::function<std::shared_ptr<eng::engine::rendering::ISprite>()> factory);

                protected:
                private:
                    std::unordered_map<std::string, std::shared_ptr<eng::engine::rendering::ITexture>> _CacheTextures;
