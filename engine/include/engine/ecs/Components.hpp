...
using TransformComponent = ECS::Transform;
using VelocityComponent = ECS::Velocity;
using SpriteComponent = ECS::Sprite;
using HealthComponent = ECS::Health;
using DamageComponent = ECS::Damage;
using AIComponent = ECS::AIController;
using CollisionComponent = ECS::Collider;
using PlayerComponent = ECS::Player;
using EnemyComponent = ECS::Enemy;
using ProjectileComponent = ECS::Projectile;
using PowerUpComponent = ECS::PowerUp;
