...
std::shared_ptr<eng::engine::rendering::ITexture> eng::core::ResourceManager::getTexture(
...
std::shared_ptr<eng::engine::rendering::ISprite> eng::core::ResourceManager::getSprite(
    const std::string& path) {
    // Try to find in cache
...
void eng::core::ResourceManager::setTextureFactory(
    std::function<std::shared_ptr<eng::engine::rendering::ITexture>()> factory) {
    _textureFactory = factory;
}

void eng::core::ResourceManager::setSpriteFactory(
