...
collectables_config = {
    ...
    powerups = {
        orange = {
            ...
            scale = {x = 0.15, y = 0.15},  -- Scale augmenté pour ~92x61 pixels
    ...
    modules = {
        laser = {
            type = "module_laser",
            name = "Laser Module",
            description = "Tire un laser continu qui traverse les ennemis",
        ...
        homing = {
            type = "module_homing",
            name = "Homing Module",
            description = "Tire des missiles qui suivent les ennemis",
            
            -- Sprite animé
            texture_path = "assets/players/homing_module.png",
            rect = {x = 0, y = 0, width = 17, height = 18},
            scale = {x = 2.0, y = 2.0},
            
            -- Animation (plus de frames)
            animation = {
                frame_count = 12,
                frame_width = 17,
                frame_height = 18,
